<#
 ...
 .PARAMETER resourceGroupName
    ...
    C:\>az group create -n fkubernetes9 -l eastus2 # Create a resource group fkubernetes9
    C:\>az group delete -n fkubernetes9 # Delete the resource group - always delete the Kubernetes 
...
param(
 ...
 [Parameter(Mandatory=$false)]
 [string]
 $resourceGroupName = "fkubernetes7",
 ...
 [Parameter(Mandatory=$false)]
 [string]
 $deploymentName = "fkubernetes7_deployment",
